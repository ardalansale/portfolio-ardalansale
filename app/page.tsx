export default function Home() {
  return (
    <main className="flex flex-col gap-2">
      <h1 className='text-4xl font-bold'>Ardalan Sale</h1>
      <h2 className='text-2xl'>UX Designer & Web Developer</h2>
      <div className="space-y-4 md:space-y-6">
        ...
        I&apos;m currently seeking internship opportunities for the period October 30, 2025 - January 29, 2026.
        </p>
      </div>
    </main>
  );
