...
export default function Card ({ color, title, category, description }: Cardprops) {
    return (
        <div className="flex flex-col p-5 gap-2 bg-white border-1 border-gray-200 rounded-lg cursor-pointer shadow-md hover:shadow-xl transition-shadow duration-300">
